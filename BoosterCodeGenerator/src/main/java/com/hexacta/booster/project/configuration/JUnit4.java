 ...
 * 
 */
public class JUnit4 extends TestingTool {
     ...
     */
    @Override
    void generateTestCodeIn(final JavaDAOGenerator javaDAOGenerator, final Spring spring, final Hibernate hibernate,
     ...
     */
    @Override
    void generateTestCodeIn(final JavaDAOGenerator javaDAOGenerator, final Spring spring,
            final JpaHibernate jpaHibernate, final ProjectConfigurationTool projectConfigurationTool,
            final CodeGeneratorConfiguration codeGeneratorConfiguration, final GenerationInfo generationInfo) {
