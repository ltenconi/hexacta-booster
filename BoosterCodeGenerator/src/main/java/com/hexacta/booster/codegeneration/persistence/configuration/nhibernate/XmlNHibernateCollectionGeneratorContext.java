 ...
 * 
 */
public class XmlNHibernateCollectionGeneratorContext {
    ...
    public XmlNHibernateCollectionGeneratorContext(final Document xmlMapping, final CollectionType collectionType,
