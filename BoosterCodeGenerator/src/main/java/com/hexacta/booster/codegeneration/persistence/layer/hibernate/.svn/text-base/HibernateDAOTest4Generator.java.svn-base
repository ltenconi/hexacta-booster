 ...
 * 
 */
public class HibernateDAOTest4Generator implements TextFileGenerator {
    ...
    public TextFile generate(final Class entityClass, final CodeGeneratorConfiguration aCodeGeneratorConfiguration)
        ...
        MetaTemplate daoTemplate = (MetaTemplate) MetaTemplateSystem.get(TemplatesNames.getName("TEST4_HIBERNATE_DAO"));
