 ...
 * 
 */
public class XmlNHibernateMappingGenerator {

    private XmlNHibernateCollectionGenerator hibernateCollectionGenerator;

    public XmlNHibernateMappingGenerator() {
        hibernateCollectionGenerator = new XmlNHibernateCollectionGenerator();
    }
    ...
    public Document generateXmlMappingFor(final OrmMapping ormMapping,
        ...
        hibernateMapping.setAttribute("assembly", "Model");
        hibernateMapping.setAttribute("namespace", ormMapping.getMappingClass().getPackage());
    ...
    public Document generateMappingFor(final XmlNHibernateMappingGeneratorContext hibernateMappingGeneratorContext) {
    ...
    public void generateIdElement(final XmlNHibernateMappingGeneratorContext hibernateMappingGeneratorContext) {
    ...
    public void setToGenerateCodeForSubMapping(
            final XmlNHibernateMappingGeneratorContext hibernateMappingGeneratorContext, final OrmMapping subOrmMapping) {
    ...
    public void generateDiscriminatorElement(final XmlNHibernateMappingGeneratorContext hibernateMappingGeneratorContext) {
    ...
    public boolean hasDiscriminator(final XmlNHibernateMappingGeneratorContext hibernateMappingGeneratorContext) {
    ...
    public void generateCodeFor(final OrmProperty ormProperty,
        ...
        if (varType.isCollection()) {
            ...
            XmlNHibernateCollectionGeneratorContext hibernateCollectionGeneratorContext = new XmlNHibernateCollectionGeneratorContext(
