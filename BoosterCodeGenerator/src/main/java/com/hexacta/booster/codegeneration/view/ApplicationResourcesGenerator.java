...
/**
 * Given an entity this class generates the text for the ApplicationResources in
 * the view layer
 * 
 ...
 * 
 */
public class ApplicationResourcesGenerator implements TextFileGenerator {
    ...
    public TextFile generate(final Class entityClass, final CodeGeneratorConfiguration codeGeneratorConfiguration)
        ...
        TextFile textFile = new TextFile(appResourcesText, "ApplicationResources.properties", PathBuilder
