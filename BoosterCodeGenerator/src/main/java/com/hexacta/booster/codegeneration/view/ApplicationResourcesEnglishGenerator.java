...
/**
 * Given an entity this class generates the text in english for the
 ...
 * 
 */
public class ApplicationResourcesEnglishGenerator implements TextFileGenerator {
    /**
     * {@inheritDoc}
     */
    ...
    public TextFile generate(final Class entityClass, final CodeGeneratorConfiguration codeGeneratorConfiguration)
        ...
        TextFile textFile = new TextFile(appResourcesText, "ApplicationResources_en.properties", PathBuilder
