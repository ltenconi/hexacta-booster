 ...
 *
 */
public class TransactionalTestGenerator implements TextFileGenerator {

    public TransactionalTestGenerator() {
    }
    ...
    public TextFile generate(final Class entityClass, final CodeGeneratorConfiguration codeGeneratorConfiguration)
        ...
        MetaTemplate serviceInterfaceTemplate = (MetaTemplate) MetaTemplateSystem.get(TemplatesNames
                .getName("TEST_TRANSACCIONAL_SERVICE"));

        Map<MetaVariable, Object> metaVariablesValue = new HashMap<MetaVariable, Object>();

        metaVariablesValue.put(new MetaVariable("testTransactionalServicePackage"), PackageNameBuilder
                .buildForTransactionalTest(entityClass));
        ...
        metaVariablesValue.put(new MetaVariable("mockServicePackage"), PackageNameBuilder
                .buildForServiceImplementationMock(entityClass));
        metaVariablesValue.put(new MetaVariable("transactionalServiceTestClassName"), JavaClassNameBuilder
                .buildForTransactionalTest(entityClass));
        metaVariablesValue.put(new MetaVariable("serviceVarName"), VarNameBuilder.buildForService(entityClass));
        metaVariablesValue.put(new MetaVariable("daoVarName"), VarNameBuilder.buildForDAO(entityClass));
        metaVariablesValue.put(new MetaVariable("implementationServiceClassName"), JavaClassNameBuilder
        ...
        TextFile textFile = new TextFile(serviceInterfaceText, JavaClassFileNameBuilder
                .buildForTransactionalTest(entityClass), PathBuilder.buildForTransactionalService(entityClass,
