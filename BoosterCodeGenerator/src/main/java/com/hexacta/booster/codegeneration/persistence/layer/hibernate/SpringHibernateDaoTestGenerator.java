...
/**
 * This class generates the test for a DAO file.
 */

public class SpringHibernateDaoTestGenerator implements TextFileGenerator {

    static final Logger logger = Logger.getLogger(SpringHibernateDaoTestGenerator.class);

    public SpringHibernateDaoTestGenerator() {
    ...
    public TextFile generate(final Class aClass, final CodeGeneratorConfiguration aCodeGeneratorConfiguration)
        ...
        MetaTemplate daoTemplate = (MetaTemplate) MetaTemplateSystem.get(TemplatesNames
                .getName("TEST_HIBERNATE_SPRING_DAO"));
